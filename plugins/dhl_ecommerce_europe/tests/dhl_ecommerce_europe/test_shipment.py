...
ShipmentPayload = {
    "service": "dhl_ecommerce_europe_local_delivery",
    "shipper": {
        "street_number": "123",
    ...
    "options": {
        ...
        "declared_value": 20.0,
        "dhl_ecommerce_europe_extra_compensation": 5.0,
        "signature_required": True,
        "email_notification": False,
        "dhl_ecommerce_europe_over_21_required": False,
        "dhl_ecommerce_europe_trailer_required": False,
    },
