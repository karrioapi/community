...
#
# Generated Fri Jul  4 13:16:04 2025 by generateDS.py version 2.44.3.
# Python 3.12.9 (main, Apr  4 2025, 10:59:48) [Clang 17.0.0 (clang-1700.0.13.3)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/shipengine/error.py')
#
# Command line arguments:
#   ./schemas/error_response.xsd
#
# Command line:
#   /Users/shadrackaddo/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/shipengine/error.py" ./schemas/error_response.xsd
#
...
#
class error_response(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, error_response)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if error_response.subclass:
            return error_response.subclass(*args_, **kwargs_)
        else:
            return error_response(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='error-response', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('error-response')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'error-response':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='error-response')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='error-response', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='error-response'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='error-response', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class errorType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, code=None, message=None, details=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'error_response'
        rootClass = error_response
...
NamespaceToDefMappings_ = {'http://shipengine.com/ws/error': []}
