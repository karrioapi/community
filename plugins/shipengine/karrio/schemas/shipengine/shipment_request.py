...
#
# Generated Fri Jul  4 13:16:05 2025 by generateDS.py version 2.44.3.
# Python 3.12.9 (main, Apr  4 2025, 10:59:48) [Clang 17.0.0 (clang-1700.0.13.3)]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/shipengine/shipment_request.py')
#
# Command line arguments:
#   ./schemas/shipment_request.xsd
#
# Command line:
#   /Users/shadrackaddo/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/shipengine/shipment_request.py" ./schemas/shipment_request.xsd
#
...
#
class shipment_request(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, shipper=None, recipient=None, packages=None, service=None, options=None, label_type=None, gds_collector_=None, **kwargs_):
        ...
        self.label_type_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, shipment_request)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if shipment_request.subclass:
            return shipment_request.subclass(*args_, **kwargs_)
        else:
            return shipment_request(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            self.label_type is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='shipment-request', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('shipment-request')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'shipment-request':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='shipment-request')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='shipment-request', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='shipment-request'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='shipment-request', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.options is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%soptions>%s</%soptions>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.options), input_name='options')), namespaceprefix_ , eol_))
        if self.label_type is not None:
            namespaceprefix_ = self.label_type_nsprefix_ + ':' if (UseCapturedNS_ and self.label_type_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%slabel-type>%s</%slabel-type>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.label_type), input_name='label-type')), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'shipper':
            ...
            obj_ = recipientType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.recipient = obj_
        ...
        elif nodeName_ == 'label-type':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'label_type')
            value_ = self.gds_validate_string(value_, node, 'label_type')
            self.label_type = value_
            self.label_type_nsprefix_ = child_.prefix
# end class shipment_request
...
class shipperType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, address_line1=None, city=None, postal_code=None, country_code=None, state_code=None, person_name=None, company_name=None, phone_number=None, email=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.address_line1_nsprefix_ = None
        self.city = city
        ...
        self.state_code_nsprefix_ = None
        self.person_name = person_name
        self.person_name_nsprefix_ = None
        self.company_name = company_name
        self.company_name_nsprefix_ = None
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='shipperType', fromsubclass_=False, pretty_print=True):
        ...
        if self.address_line1 is not None:
            namespaceprefix_ = self.address_line1_nsprefix_ + ':' if (UseCapturedNS_ and self.address_line1_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%saddress-line1>%s</%saddress-line1>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.address_line1), input_name='address-line1')), namespaceprefix_ , eol_))
        ...
        if self.state_code is not None:
            namespaceprefix_ = self.state_code_nsprefix_ + ':' if (UseCapturedNS_ and self.state_code_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sstate-code>%s</%sstate-code>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.state_code), input_name='state-code')), namespaceprefix_ , eol_))
        if self.person_name is not None:
            namespaceprefix_ = self.person_name_nsprefix_ + ':' if (UseCapturedNS_ and self.person_name_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sperson-name>%s</%sperson-name>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.person_name), input_name='person-name')), namespaceprefix_ , eol_))
        if self.company_name is not None:
            namespaceprefix_ = self.company_name_nsprefix_ + ':' if (UseCapturedNS_ and self.company_name_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scompany-name>%s</%scompany-name>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.company_name), input_name='company-name')), namespaceprefix_ , eol_))
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        pass
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'address-line1':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'address_line1')
            value_ = self.gds_validate_string(value_, node, 'address_line1')
            self.address_line1 = value_
            self.address_line1_nsprefix_ = child_.prefix
        elif nodeName_ == 'city':
            value_ = child_.text
        ...
        elif nodeName_ == 'state-code':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'state_code')
            value_ = self.gds_validate_string(value_, node, 'state_code')
            self.state_code = value_
            self.state_code_nsprefix_ = child_.prefix
        elif nodeName_ == 'person-name':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'person_name')
            value_ = self.gds_validate_string(value_, node, 'person_name')
            self.person_name = value_
            self.person_name_nsprefix_ = child_.prefix
        elif nodeName_ == 'company-name':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'company_name')
            value_ = self.gds_validate_string(value_, node, 'company_name')
            self.company_name = value_
            self.company_name_nsprefix_ = child_.prefix
...
class recipientType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, address_line1=None, city=None, postal_code=None, country_code=None, state_code=None, person_name=None, company_name=None, phone_number=None, email=None, gds_collector_=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, recipientType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if recipientType.subclass:
            return recipientType.subclass(*args_, **kwargs_)
        else:
            return recipientType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='recipientType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('recipientType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'recipientType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='recipientType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='recipientType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='recipientType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='recipientType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class packageType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, weight=None, weight_unit=None, length=None, width=None, height=None, dimension_unit=None, packaging_type=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.dimension_unit_nsprefix_ = None
        self.packaging_type = packaging_type
        self.packaging_type_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def get_dimension_unit(self):
        return self.dimension_unit
    def set_dimension_unit(self, dimension_unit):
        self.dimension_unit = dimension_unit
    def get_packaging_type(self):
        return self.packaging_type
    def set_packaging_type(self, packaging_type):
        self.packaging_type = packaging_type
    def has__content(self):
        if (
            ...
            self.dimension_unit is not None or
            self.packaging_type is not None
        ):
            return True
        else:
            return False
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='packageType', fromsubclass_=False, pretty_print=True):
        ...
        if self.weight_unit is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sweight-unit>%s</%sweight-unit>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.weight_unit), input_name='weight-unit')), namespaceprefix_ , eol_))
        ...
        if self.dimension_unit is not None:
            namespaceprefix_ = self.dimension_unit_nsprefix_ + ':' if (UseCapturedNS_ and self.dimension_unit_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdimension-unit>%s</%sdimension-unit>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.dimension_unit), input_name='dimension-unit')), namespaceprefix_ , eol_))
        if self.packaging_type is not None:
            namespaceprefix_ = self.packaging_type_nsprefix_ + ':' if (UseCapturedNS_ and self.packaging_type_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%spackaging-type>%s</%spackaging-type>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.packaging_type), input_name='packaging-type')), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'dimension-unit':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'dimension_unit')
            value_ = self.gds_validate_string(value_, node, 'dimension_unit')
            self.dimension_unit = value_
            self.dimension_unit_nsprefix_ = child_.prefix
        elif nodeName_ == 'packaging-type':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'packaging_type')
            value_ = self.gds_validate_string(value_, node, 'packaging_type')
            self.packaging_type = value_
            self.packaging_type_nsprefix_ = child_.prefix
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'shipment_request'
        rootClass = shipment_request
...
NamespaceToDefMappings_ = {'http://shipengine.com/ws/shipment': []}
