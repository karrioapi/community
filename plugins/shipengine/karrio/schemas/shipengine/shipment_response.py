...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/shipengine/shipment_response.py')
#
# Command line arguments:
#   ./schemas/shipment_response.xsd
#
# Command line:
#   /Users/shadrackaddo/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/shipengine/shipment_response.py" ./schemas/shipment_response.xsd
#
...
#
class shipment_response(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, tracking_number=None, shipment_identifier=None, label_type=None, label=None, documents=None, meta=None, gds_collector_=None, **kwargs_):
        ...
        self.shipment_identifier_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, shipment_response)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if shipment_response.subclass:
            return shipment_response.subclass(*args_, **kwargs_)
        else:
            return shipment_response(*args_, **kwargs_)
    ...
    def set_tracking_number(self, tracking_number):
        self.tracking_number = tracking_number
    def get_shipment_identifier(self):
        return self.shipment_identifier
    def set_shipment_identifier(self, shipment_identifier):
        self.shipment_identifier = shipment_identifier
    ...
    def has__content(self):
        if (
            ...
            self.shipment_identifier is not None or
            self.label_type is not None or
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='shipment-response', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('shipment-response')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'shipment-response':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='shipment-response')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='shipment-response', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='shipment-response'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='shipment-response', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.shipment_identifier is not None:
            namespaceprefix_ = self.shipment_identifier_nsprefix_ + ':' if (UseCapturedNS_ and self.shipment_identifier_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sshipment-identifier>%s</%sshipment-identifier>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.shipment_identifier), input_name='shipment-identifier')), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'shipment-identifier':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'shipment_identifier')
            value_ = self.gds_validate_string(value_, node, 'shipment_identifier')
            self.shipment_identifier = value_
            self.shipment_identifier_nsprefix_ = child_.prefix
...
class documentsType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, invoice=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='documentsType', fromsubclass_=False, pretty_print=True):
        ...
        if self.invoice is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sinvoice>%s</%sinvoice>%s' % (namespaceprefix_ , self.gds_format_base64(self.invoice, input_name='invoice'), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
        ...
        if nodeName_ == 'invoice':
            ...
            if sval_ is not None:
                try:
                    ...
                    raise_parse_error(child_, 'requires base64 encoded string: %s' % exp)
                bval_ = self.gds_validate_base64(bval_, node, 'invoice')
            else:
                bval_ = None
            self.invoice = bval_
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'shipment_response'
        rootClass = shipment_response
