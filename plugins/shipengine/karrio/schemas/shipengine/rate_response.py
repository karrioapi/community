...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/shipengine/rate_response.py')
#
# Command line arguments:
#   ./schemas/rate_response.xsd
#
# Command line:
#   /Users/shadrackaddo/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/shipengine/rate_response.py" ./schemas/rate_response.xsd
#
...
#
class rate_response(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, rate=None, gds_collector_=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, rate_response)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if rate_response.subclass:
            return rate_response.subclass(*args_, **kwargs_)
        else:
            return rate_response(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='rate-response', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('rate-response')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'rate-response':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='rate-response')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='rate-response', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='rate-response'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='rate-response', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class rateType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, service_code=None, service_name=None, total_charge=None, currency=None, transit_days=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.total_charge_nsprefix_ = None
        self.currency = currency
        self.currency_nsprefix_ = None
        self.transit_days = transit_days
        self.transit_days_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def get_transit_days(self):
        return self.transit_days
    def set_transit_days(self, transit_days):
        self.transit_days = transit_days
    def has__content(self):
        if (
            self.service_code is not None or
            self.service_name is not None or
            self.total_charge is not None or
            self.currency is not None or
            self.transit_days is not None
        ):
            return True
        else:
            return False
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='rateType', fromsubclass_=False, pretty_print=True):
        ...
        if self.total_charge is not None:
            namespaceprefix_ = self.total_charge_nsprefix_ + ':' if (UseCapturedNS_ and self.total_charge_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%stotal-charge>%s</%stotal-charge>%s' % (namespaceprefix_ , self.gds_format_decimal(self.total_charge, input_name='total-charge'), namespaceprefix_ , eol_))
        ...
        if self.transit_days is not None:
            namespaceprefix_ = self.transit_days_nsprefix_ + ':' if (UseCapturedNS_ and self.transit_days_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%stransit-days>%s</%stransit-days>%s' % (namespaceprefix_ , self.gds_format_integer(self.transit_days, input_name='transit-days'), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'total-charge' and child_.text:
            sval_ = child_.text
            fval_ = self.gds_parse_decimal(sval_, node, 'total_charge')
            fval_ = self.gds_validate_decimal(fval_, node, 'total_charge')
            self.total_charge = fval_
            self.total_charge_nsprefix_ = child_.prefix
        ...
        elif nodeName_ == 'transit-days' and child_.text:
            sval_ = child_.text
            ival_ = self.gds_parse_integer(sval_, node, 'transit_days')
            ival_ = self.gds_validate_integer(ival_, node, 'transit_days')
            self.transit_days = ival_
            self.transit_days_nsprefix_ = child_.prefix
# end class rateType
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'rate_response'
        rootClass = rate_response
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from rate_response import *\n\n')
        sys.stdout.write('import rate_response as model_\n\n')
