...
#   ('--no-namespace-defs', '')
#   ('-o', './karrio/schemas/shipengine/rate_request.py')
#
# Command line arguments:
#   ./schemas/rate_request.xsd
#
# Command line:
#   /Users/shadrackaddo/karrio/.venv/karrio/bin/generateDS --no-namespace-defs -o "./karrio/schemas/shipengine/rate_request.py" ./schemas/rate_request.xsd
#
...
#
class rate_request(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, shipper=None, recipient=None, packages=None, services=None, options=None, gds_collector_=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, rate_request)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if rate_request.subclass:
            return rate_request.subclass(*args_, **kwargs_)
        else:
            return rate_request(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='rate-request', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('rate-request')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'rate-request':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='rate-request')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='rate-request', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='rate-request'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='rate-request', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class servicesType(GeneratedsSuper):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='servicesType', fromsubclass_=False, pretty_print=True):
        ...
        for service_ in self.service:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sservice>%s</%sservice>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(service_), input_name='service')), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'rate_request'
        rootClass = rate_request
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from rate_request import *\n\n')
        sys.stdout.write('import rate_request as model_\n\n')
...
NamespaceToDefMappings_ = {'http://shipengine.com/ws/rate': []}
